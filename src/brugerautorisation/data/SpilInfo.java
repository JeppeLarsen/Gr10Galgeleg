...
public class SpilInfo {
    ...
    public SpilInfo(String ordet, String synligtOrd, int antalForkerteBogstaver, boolean sidsteBogstavVarKorrekt, boolean spilletErVundet, boolean spilletErTabt) {
        this.ordet = ordet;
